...
import HeroImage from '../../../public/images/Portrait of a Young Man 1.png';

const HeroProfile = () => {
  return (
    <div
      className='relative z-10 mx-auto overflow-hidden md:ml-4'
      style={{
    ...
    >
      ...
      <div className='absolute inset-x-0 bottom-0 h-[80%] bg-linear-to-t from-black to-transparent' />
      ...
      <motion.div
        ...
        className='absolute bottom-1 left-1/2 z-10 h-34.5 w-full -translate-x-[50%] rounded-2xl border border-neutral-800 bg-black p-4 opacity-0 md:bottom-[9.6%] md:h-44.5 md:w-79 md:rounded-3xl md:p-5'
        style={{
